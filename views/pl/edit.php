...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form action="/pl/update" method="POST" class="needs-validation" novalidate>
            <input type="hidden" name="id" value="<?php echo htmlspecialchars($plAccount['id']); ?>">
            
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="pan" class="form-label">PAN Number</label>
                    <input type="text" class="form-control" id="pan" name="pan" value="<?php echo htmlspecialchars($plAccount['pan']); ?>" required pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="assessment_year" name="assessment_year" value="<?php echo htmlspecialchars($plAccount['assessment_year']); ?>" required pattern="[0-9]{4}-[0-9]{2}">
                    <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="gross_profit" name="gross_profit" value="<?php echo htmlspecialchars($plAccount['gross_profit']); ?>" required step="0.01">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="indirect_income" name="indirect_income" value="<?php echo htmlspecialchars($plAccount['indirect_income']); ?>" required step="0.01">
                    <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="indirect_expenses" name="indirect_expenses" value="<?php echo htmlspecialchars($plAccount['indirect_expenses']); ?>" required step="0.01">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="net_profit" name="net_profit" value="<?php echo htmlspecialchars($plAccount['net_profit']); ?>" readonly step="0.01">
                </div>
            </div>

            <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Update P&L Account</button>
        </form>
    </div>
</div>
