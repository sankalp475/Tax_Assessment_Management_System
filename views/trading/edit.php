<?php
$title = "Edit Trading Account - Tax Assessment System";
ob_start();
?>
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <form action="/trading/update" method="POST" class="needs-validation" novalidate>
            <input type="hidden" name="id" value="<?php echo htmlspecialchars($tradingAccount['id']); ?>">

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="pan" class="form-label">PAN Number</label>
                    <input type="text" class="form-control" id="pan" name="pan" value="<?php echo htmlspecialchars($tradingAccount['pan']); ?>" required pattern="[A-Z]{5}[0-9]{4}[A-Z]{1}">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="assessment_years" name="assessment_years" value="<?php echo htmlspecialchars($tradingAccount['assessment_years']); ?>" required pattern="[0-9]{4}-[0-9]{2}">
                    <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="opening_stock" name="opening_stock" value="<?php echo htmlspecialchars($tradingAccount['opening_stock']); ?>" required step="0.01">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="purchases" name="purchases" value="<?php echo htmlspecialchars($tradingAccount['purchases']); ?>" required step="0.01">
                    <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="direct_expenses" name="direct_expenses" value="<?php echo htmlspecialchars($tradingAccount['direct_expenses']); ?>" required step="0.01">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="closing_stock" name="closing_stock" value="<?php echo htmlspecialchars($tradingAccount['closing_stock']); ?>" required step="0.01">
                    <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="gross_profit" name="gross_profit" value="<?php echo htmlspecialchars($tradingAccount['gross_profit']); ?>" readonly step="0.01">
            </div>

            <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Update Trading Account</button>
        </form>
    </div>
</div>
